...
<html lang="en" dir="ltr">
  ...
  -->
    ...
    <div class = "privacy_policy">
      ...
      <p>CodingForFishers operates the fhsched.com website, which provides services directed to help the students and staff.</p>

      <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of personal information if anyone decided to use our service, the FHSched website.</p>

      <p>If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>

      <h2>Information Collection and Use</h2>

      <p>For a better experience while using our service, we may require you to provide us with certain personally identifiable information, including but not limited to your name, and school related information. The information that we collect will be used to contact or identify you.</p>
